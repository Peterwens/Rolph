                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Programmation de l'equipe de Basket-ball de l'unasmoh</h4>
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="Basket-ball" class="validate" required>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="ho-ev-link pg-eve-desc">
                                            <a >
                                                <h4>Championnat universitaire</h4>
                                            </a>
                                            <p>Unasmoh vs Inuka</p>

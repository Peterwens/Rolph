        ...
        <div class="head-2">
            <div class="container">
                <div class="head-2-inn">
                    <h1>Options et Cours</h1>
                    <p>Listes des cours par Année de chaque faculté .</p>
                            ...
                            <li>
                                ...
                                <div class="s17-eve-time">
                                    ...
                                    <div class="s17-eve-time-msg">
                                        <h4>Science informatique</h4>
                                       
                                        <div class="time-hide time-hide-1">
                                            <h5>Premiere Anneé</h5>
                                            <p> Cours.</p>
                                            <h5>Deuxieme Anneé</h5>
                                            <p> Cours.</p>
                                            <h5>Troisieme Anneé</h5>
                                            <p> Cours.</p>
												
											<h5>Quatriéme Anneé</h5>
                                            <p> Cours.</p>
                                        </div>
							  ...
							  <li>
                                ...
                                <div class="s17-eve-time">
                                    ...
                                    <div class="s17-eve-time-msg">
                                        <h4>Sciences infirmiéres</h4>
                                       
                                        <div class="time-hide time-hide-1">
                                            <h5>Premiere Année</h5>
                                            <p> Cours.</p>
                                            <h5>Deuxieme Anneé</h5>
                                            <p> Cours.</p>
                                            <h5>Troisieme Anneé</h5>
                              ...
                              <li>
                               ...
                               <li>
                                ...
                                <div class="s17-eve-time">
                                    ...
                                    <div class="s17-eve-time-msg">
                                        <h4>Ecole Normsle superieure</h4>
							   ...
							   <li>
                                ...
                                <div class="s17-eve-time">
                                    ...
                                    <div class="s17-eve-time-msg">
                                        <h4>Science du développement</h4>

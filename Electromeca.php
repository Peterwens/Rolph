            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="#"> Eléctro Mecanique</a>
                        </li>
                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Historicité Electro Mecanique</h4>
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="Eléctro Mecanique " class="validate" required>
...
<b>L'ingénieur électromécanique </b>   (Ingénieur en génie électromécanique ) est le spécialiste des systèmes mécaniques constitués d’éléments électriques. L’ingénieurie en électromagnétique est une spécialité rare.</br></br>
Un ingénieur électromécanicien est spécialiste dans la conception et la maintenance de systèmes mécaniques mais aussi de systèmes électriques.</b></br>
La complémentarité entre les sciences fondamentales et l’ingénierie, font que cette formation soit très convoitée par les industriels. </br>
L'électromécanique est un domaine étudié depuis longtemps. Cependant, il reste constamment l'objet d'innovations technologiques. 
Il conçoit et met à l'essai des installations et des éléments électroniques utilisés dans plusieurs secteurs tels que l'énergie, 
l'aviation, la communication, l'informatique ou la télécommunication, le domaine médical, l'automation, l'énergie, et plusieurs autres secteurs. </br></br>
L’ingénieur en électromécanique est amené à évoluer au sein de nombreux domaines d’activités : </br>
•	Concevoir et tester des systèmes électroniques dédiés à différents secteurs de la société (énergie, aviation, communication, informatique et télécommunications, médical, automation, ...). </br>
•	Estimer les coûts de fabrication, d'installation, d'entretien et de maintenance des systèmes électromécaniques. </br>
•	Développer du prototype au produit final un système électromécanique dédié à un secteur particulier de la société. </br>
•	De nombreux autres défis attendent l'ingénieur électromécanicien. </br>
•	Installer des machines neuves dans une usine. </br>
•	Effectuer le montage des éléments de la machine. </br>
•	Contrôler et prévenir les risques de pannes de façon régulière. </br>
•	Procéder à la réparation (ou faire réparer, ou faire changer) du matériel défectueux Peu d'autres applications pratiques de l'électromécanique sont : </br>
•	Micro-systèmes électromécaniques
•	Véhicule et sous-système de véhicule.</br></br>
</br> <b>Salaire</b></br>

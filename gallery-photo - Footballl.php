        ...
        <div class="head-2">
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    ...
                    <p>Ici vous trouverez les photos de l'equipe de football.</p>
            ...
            <div class="row">
                <div class="cor about-sp h-gal ed-pho-gal">
					<ul>
						...
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/gg.jpg" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/ff.jpg" alt="">
						</li>
					    <li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j5.jpg" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j6.jpg" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j5.jpg" alt="">
						</li>
						
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j1.jpg" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j2.jpg" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j3.jpg" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de football" src="images/slider/j4.jpg" alt="">
						</li>

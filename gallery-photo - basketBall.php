        ...
        <div class="head-2">
            <div class="container">
                <div class="head-2-inn head-2-inn-padd-top">
                    ...
                    <p>Ici vous trouverez les photos de l'equipe de Basket-ball.</p>
		...
		<div class="container com-sp pad-bot-70 ed-res-bg">
            <div class="row">
                <div class="cor about-sp h-gal ed-pho-gal">
					<ul>
						<li><img class="materialboxed" data-caption="Equipe de Basket-ball" src="images/slider/basket1.jfif" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe de Basket-ball" src="images/slider/basket2.jfif" alt="">
						</li>
						<li><img class="materialboxed" data-caption="Equipe Basket-ball" src="images/slider/basket3.jfif" alt="">
						</li>
					    <li><img class="materialboxed" data-caption="Equipe de Basket-ball" src="images/slider/basket4.jfif" alt="">
						</li>					
						<li><img class="materialboxed" data-caption="Equipe de Basket-ball" src="images/slider/basket5.jfif" alt=""> 
						</li>

                    ...
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            ...
                            <ul>
                                ...
                                <ul><a href="sport.html"><b>Sport</b></a></ul>
        ...
        <div class="row">
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header" href="Informatique.html"><i class="fa fa-book" aria-hidden="true"></i> Volley-Ball</a>
                            <div class="collapsible-body left-sub-menu">
                               <ul>
							 
							    
							 <li><a href="sportProgVolleyball.html" style="color:black; " ><b>Matchs</b></a>
                                    </li>
									<li><a href="gallery-photo - Volleyball.html" style="color:black;"><b>Photo</b></a>
                                    </li>
							   </ul>
                            </div>
							
							<li><a href="javascript:void(0)" class="collapsible-header" href="Informatique.html"><i class="fa fa-book" aria-hidden="true"></i> Football</a>
                            <div class="collapsible-body left-sub-menu">
                                 <ul>
								 
							   <li><a href="sportProgFootball.html"  style="color:black;"><b>Matchs</b></a>
                                    </li>
									<li><a href="gallery-photo - Footballl.html"  style="color:black;"><b>Photo</b></a>
                                    </li>
							   </ul>
                            </div>
							<li><a href="javascript:void(0)" class="collapsible-header" href="Informatique.html"><i class="fa fa-book" aria-hidden="true"></i> Basket-ball</a>
                            <div class="collapsible-body left-sub-menu">
                                 <ul>
								   
							   <li><a href="sportProgBasketball.html " style="color:black;"><b>Matchs</b></a>
                                    </li>
									<li><a href="gallery-photo - basketBall.html" style="color:black;"><b>Photo</b></a>
                                    </li>
							   </ul>
                            </div>
                        </li>
            ...
            <div class="sb2-2">
                ...
                <div class="sb2-2-2">
                    <ul>
                        ...
                        <li class="active-bre"><a href="sport.html"> Sport</a>
                        </li>
                ...
                <div class="sb2-2-3">
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    <h4>Historicité du sport a l'unasmoh</h4>
                                    ...
                                    <form>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" value="Sport " class="validate" required>
										...
										<align>	
Le sport a toujours été depuis longtemps l’un des activités principales de l’unasmoh (Université américaines des sciences modernes d’Haïti) à travers les ans ils se sont imposés dans pratiquement tous les championnats auxquels ils ont participé que ce soit à travers le football, le basket ou encore le volleyball.
A ce jour la galerie de trophées de l’unasmoh est énormément bien garnie de trophées de tout genre venant de ces trois disciplines far et n’est pas prêt à s’en arrêter là.
</br></br></br></align>
<p><b> <u>Equipe de football champion trois fois d’affilée</u></b> </P>
                                               
	<img src="images/slider/gg.jpg" alt=""></br></br>

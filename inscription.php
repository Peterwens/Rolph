...
<head>
   ...
   <link rel="shortcut icon" href="images/unasmoh.png">
    <!-- GOOGLE FONT -->
               ...
               <!--== LEFT MENU ==-->
                <div class="sb2-13">
                    <ul>
                        ...
                        <li><a> <b>UNASMOH/<i>Inscription</i></b></a></li>
                            <div class="collapsible-body left-sub-menu">
							</ul>
							
							<div class="item slider1 active">
				<!-- CHANGER IMAGE -->
                    <img src="images/slider/2.jpg" alt="" style="height:725px; ">
                    ...
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                <div class="inn-title">
                                    ...
                                    <h4><marquee>Quelques informations pour les inscriptions</marquee></h4>
                                </div>
                                <div class="tab-inn">
                                    <form>
                                        <div class="row">
                                        ...
                                        <div class="row">
											...
											<div><p style="text-align:justify"><b>L'universite Americaine Des Sciences modernes d'Haiti(UNASMOH) propose plusieurs programmes(Cycle court, licence).
											     l’objectif visé est de permettre au pays de construire des leaders éclairés et responsables pouvant affronter les défis de la globalisation.
												 <b/></p><br/>
                                            </div>
                                               
                                              <h4>Pieces réquises</h4>
											  
											  <li>Copie du diplome de fin d'étude(Bac ll), rélevé de note et attéstation</li>
											  <li>Copie de l'acte de naissance</li>
											  <li>Copie carte d'identification nationale</li>
											  <li>Deux(2) photos d'identités(recentes)</li>
											  <li><i><strong>Frais d'inscription pour le programme de Cycle court: 2000 sgourdes</strong></i></li>
											  <li><i><strong>Frais d'inscription pour le programme licence: $50 us</strong></i></li><hr/> <hr/>
											  
											 
											   
											   <h5><b>Les numéros des comptes Bancaires:</b></h5>
											   <li>SOGEBANK(gourdes) : 0000-0000-00000</li>
											   <li>UNIBANK(gourdes) : 1401-0215-48816</li><br/><hr/>
											   
											   <p><i>Voulez-vous inscrire? si oui vueillez cliquer sur le bouton <u>INSCRIPTION</u>.</i> </p>
                                                 <div class="hom-list-share">
                                                 <ul>
                                                 <li><a href="inscription22.html"><b>INSCRIPTION</b></a> </li>

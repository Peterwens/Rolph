                        ...
                        <div class="search-form">
                            <form>
                                <div class="sf-type">
                                    ...
                                    <div class="sf-list">
                                        <ul>
                                            <li><a href="Comptable.html">Comptabilité/Finance</a></li>
                                            <li><a href="Genie1.html">Génie Civil</a></li>
                                            <li><a href="Administration.html">Sciences Administratives</a></li>
                                            <li><a href="Agronomie.html">Agronomie</a></li>
                                            <li><a href="Electromeca.html">Genie Eléctronique</a></li>
                                            <li><a href="Infirmiere.html">Sciences infirimiéres</a></li>
                                            <li><a href="laboratoireM.html">Laboratoire Médicale</a></li>
                                            <li><a href="Sciences Juridiques.html">Science juridiques</a></li>
                                            <li><a href="EcoleN.html">Ecole Normale supérieure</a></li>
            ...
            <div class="row">
                <div class="cor apropos-sp">
                    <div class="ed-apropos-tit">
                        <div class="con-title">
                            <h2>Actualités <span> Importantes</span></h2>
                            <p>Evènements qui seront organisés dans les jours qui viennent et qui merite votre attention.</p>
                        </div>
                    </div>
                        ...
                        <div class="ed-advan">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        <h4>Journée Technologique</h4>
                                        <p>Unasmoh vous invite a sa premier édition de journée technologique qui aura lieu le 22 octobre prochain, et vous invite a venir en foule.</br>.</p>
                                ...
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        ...
                                        <p>Unasmoh vous annonces que le week-end scientifique de cette anneé n'aura pas lieu en raison d'imprevus ,et vous remercie de votre compréhension. </br>.</p>
                                ...
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        <h4>FAETAS</h4>
                                        <p> La faculté des études Avancées et spécialisées (FAETAS) Vous annonce que ses inscriptions se feront du 17 octobre au 15 Novembre prochain.</p>
                                ...
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        <h4>SPORT</h4>
                                        <p>La finale du championnat universitaire qui opposera Unasmoh et Unika aura lieu le 3 octobre prochain , nous comptons sur votre présence.</p>
                                ...
                                <li>
                                    ...
                                    <div class="ed-ad-dec">
                                        <h4>Académique</h4>
                                        <p>L'université Unasmoh a l'honneur de vous annoncer le lancement de leurs faculté de medecine cette anneé.</p>
        ...
        <div class="container com-sp pad-bot-70">
            <div class="row">
                <div class="con-title">
                    ...
                    <p>Liste des Cours disponibles a l'université Unasmoh et l'ensemble des informations les caractérisant .</p>
                </div>
            </div>
            <div class="row">
			<div class="item">
                        ...
                        <div class="home-top-cour">
                           <!--IMAGE DES Cours POPULAIRES -->
                            ...
                            <div class="col-md-9 home-top-cour-desc">
								...
								<!-- SOUS-TITRE DU COUR POPULAIRE  -->
                                <h4>Etude de sol / Elévage / Plantation</h4>
                                <p>Cours disponible a Delmas 65 et a Pont saint geraud</p> <span class="home-top-cour-rat">4.2</span>
                                <!-- SOUS-TITRE DU COUR POPULAIRE/VIEWS/SHARE... -->
								<div class="hom-list-share">
                                    <ul>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="Infirmiere.html">
                                    <h3>Sciences Infirmiéres</h3>
                                </a>
                                <h4>Soins Primaire / Consultation / Conseilles médicales</h4>
                                <p>Cours disponible a Delmas 65 et a Pont saint geraud</p> <span class="home-top-cour-rat">4.2</span>
                                <div class="hom-list-share">
                                    <ul>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="laboratoireM.html">
                                    <h3>Laboratoire Médicale</h3>
                                </a>
                                <h4>Prescription / Dosage / Médicaments</h4>
                                <p>Cours disponible a delmas 65 et a Rue 4</p> <span class="home-top-cour-rat">4.2</span>
                                <div class="hom-list-share">
                                    <ul>
                        ...
                        <div class="home-top-cour">
						 ...
						 <div class="home-top-cour">
                            ...
                            <div class="col-md-9 home-top-cour-desc">
                                ...
                                <h4>Cahier de charge / Comptable / Gestions financiéres</h4>
                                <p>Cours desponible a Delmas 65 et a Rue 4</p> <span class="home-top-cour-rat">4.2</span>
                                <div class="hom-list-share">
                                    <ul>
...
<!-- FIN DES Cours POPULAIRES -->
    ...
    <section>
        <div class="container com-sp">
            <div class="row">
                <div class="con-title">
                    <h2>Galléries et <span>Evènements</span></h2>
                    <p>Repartition  des photo ,videos et des évènements à venir</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="bot-gal h-gal ho-event-mob-bot-sp">
                       <h4><li><a href="gallery-photo.html">Galléries Photo</a></li></h4>
                        <ul>
                ...
                <div class="col-md-4">
                    <div class="bot-gal h-vid ho-event-mob-bot-sp">
                        <h4><li><a href="gallery-video.html">Galléries Video</a></li></h4>
                        ...
                        <h5>Promotion réalisant le site web </h5>
                        <p>Unamoh a l'honneur de vous presenter les etudiants de 4em anneé science informatique promotion 2017-2021.</p>
                        <p>Qui dans leur devouement et leurs discipline ont réalisant ce site web de standard internationnal.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="bot-gal h-Cinfoca ho-event">
                       <h4><li><a href="events.html">Evènement</a></li></h4>
                        <div class="ho-event">
                            <ul>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="ho-ev-link">
                                        ...
                                        <p>Le 22 octobre prochain s'organisera la premiére edition.</p>
                                ...
                                <li>
                                    ...
                                    <div class="ho-ev-link">
                                        ...
                                        <p>Organistion de la présentation de la nouvelle.</p>
    ...
    <section class="wed-hom-footer">
        <div class="container">
            ...
            <div class="row wed-foot-link-1">
			 ...
			 <div class="col-md-4">
			<p style="margin-left:25px; ">© 2021 Tous droit Réservés UNASMOH</p></div>
        </div>
    </section>
